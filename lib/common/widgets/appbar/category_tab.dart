        ...
        return [
          {
            ...
            'title': 'Pattachitra',
            'price': '230',
            'description': 'Scroll art',
            'discount': '20%'
          },
          {
            'imageUrl': TImages.productImageOD2,
            'title': 'Dhokra Metal',
            'price': '320',
            'description': 'Tribal brass',
            'discount': '25%'
          },
          {
            'imageUrl': TImages.productImageOD3,
            'title': 'Applique Work',
            'price': '260',
            'description': 'Stitch art',
            'discount': '15%'
          },
          {
            'imageUrl': TImages.productImageOD4,
      ...
      children: [
        Padding(
          ...
          child: Column(
            children: [
              TSectionHeading(
                title: '$category Handicrafts for You',
